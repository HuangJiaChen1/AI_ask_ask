...
async def main():
    ...
    print("=" * 60)
    print(f"consecutive_idk_count BEFORE Turn 1: {assistant.consecutive_idk_count}")
    print()
    ...
    print("=" * 60)
    print(f"consecutive_idk_count BEFORE Turn 2: {assistant.consecutive_idk_count}")
    print()
